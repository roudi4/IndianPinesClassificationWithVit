              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5><i class="icofont icofont-circled-down"></i> Marge globale</h5>
                  </div>
                  ...
                  <form class="form theme-form">
                    <div class="card-body">
                      ...
                      <div class="col-md-10 mb-3 justify-content-center">
                          <label class="form-label" for="validationCustomUsername">Merci d'ajouter votre taux de marge globale (le calcul est réalisé a partir du prix d'achat HT)</label>
                          <div class="input-group">
                            <input class="form-control" id="validationCustomUsername" type="text" placeholder="10" aria-describedby="inputGroupPrepend" required="">
                            <span class="input-group-text" id="inputGroupPrepend">%</span> <div class="invalid-feedback">Please choose a username.</div>
                          </div>
                          <div class="col col-2">
                          </div>
                        </div>
                      ...
                      <div class="col-md-12 text-center">
                              <button type="button" class="btn btn-success btn-sm btn-pill"><i class="icofont icofont-circled-down"></i>&nbsp;Enregistrer</button>
                      </div>  
