      ...
      <div class="page-header">
        <div class="header-wrapper row m-0"> 
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">fffff</div>
            </div>
            </div>
          </script>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5><div class="col-md-12 bg-light float-right ml-2"><button type="button" class="btn btn-success btn-sm btn-pill"><i class="icofont icofont-circled-down"></i>Aide?</button><i class="icofont icofont-circled-down"></i>Mapping catégorie</h5></div>
