      ...
      <div class="page-header">
        <div class="header-wrapper row m-0"> 
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">fff</div>
            </div>
            </div>
          </script>
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body btn-showcase">
                    <!-- Simple demo-->
                    <button class="btn btn-primary"  type="button"  data-toggle="modal" data-target="#exampleModal">Se Connecter</button>
                 ...
                 <div class="modal-dialog" role="document">
                  ...
                  <div class="modal-body">
                  <form class="theme-form" action="{{url('/connectionapi')}}" method='post'>
                              @csrf
                                  <div class="mb-3 draggable">
                                    <label for="input-text-1">client_id</label>
                                    <input class="form-control btn-square" name='client_id'id="input-text-1" type="email" placeholder="Enter email"/>
                                    
                                 </div>
                                  <div class="mb-3 draggable">
                                    <label for="input-password-1">client_secret</label>
                                    <input class="form-control btn-square" id="input-password-1" name='client_secret' type="password" placeholder="Enter Mot de passe"/>
                                ...
                                <div class="text-center ">
                                  ...
                                  <button class="btn btn-primary "  type="button" data-bs-dismiss="modal" >Se Connecter</button>
