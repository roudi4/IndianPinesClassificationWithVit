...
<html lang="en">
  ...
  <body>
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0"> 
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">jjj</div>
            </div>
            </div>
          </script>
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$ff->octobus_sku}}</td>
                            <td class="font-success">{{$ff->status_wix}}</td>
                            <td>{{$ff->lien_produit}}</td>
                            <td>
                        
                            <button class="btn btn-success mb-2" type="button" data-original-title="btn btn-danger btn-xs" title="">Envoyer</button><br>
                            <a class="btn btn-danger btn-xs"  id="deleteproduct"  href="#" onclick="deletep( {$id})"><i class="fa fa-trash"></i> supprimer</a> <br>
                            <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="">Editer</button><br>
                    ...
                    <div class="modal fade" id="dproduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <a class="btn btn-primary" id="Doctobus" href="" data-bs-dismiss="modal">supprimer depuis octobus</a>
    ...
    <!-- Plugin used-->
    <script>
      /*bech yekhdem e jquery*/
      $(document).ready( function () {
    $('#basic-1').DataTable();} );

    function deletep(idprod){
      
    console.log(idprod);
    link="{{url('/Delete_products_wix')}}/"+idproduct;
    linkoctobus="{{url('/deleteproduct')}}/"+idprod;
    $("#Doctobus").attr("href",linkoctobus);

    $("#deleteproduct").attr("href",link);
   $("#dproduct").modal('toggle');
